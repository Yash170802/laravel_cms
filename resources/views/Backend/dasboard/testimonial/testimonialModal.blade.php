    ...
    <div class="modal-dialog modal-lg modal-simple modal-add-new-address">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <form id="formTestmonial" class="row g-3" method="post" action="{{route('admin.insert')}}" enctype="multipart/form-data" onsubmit="return false">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" id="client_name" name="client_name" class="form-control" placeholder="Please Enter Client Name" />
                    </div>
                    <div class="col-12">
                        <label class="form-label" for="client_name">Company Name</label>
                        <input type="text" id="company_name" name="company_name" class="form-control" placeholder="Please Enter Company Name" />
                    </div>
                    <div class="col-12">
