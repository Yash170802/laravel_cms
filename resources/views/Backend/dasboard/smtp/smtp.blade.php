...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="formSMTPSettings" method="POST" action="{{route('admin.smtp_insert')}}" onsubmit="return false">
                    @csrf
                    <div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="formTestMail" method="POST" action="{{route('admin.send_mail')}}" onsubmit="return false">
                    @csrf
...
@section('extraJs')
<!-- smtp.js -->
<script src="{{ asset('assets/backend/js/custom/smtp/smtp.js') }}"></script>
@endsection
