        ...
        <div class="nav-align-left mb-5">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="settting_logo" role="tabpanel">
                    <form id="formlogo" method="POST" action="{{ route('admin.logo_insert') }}"
                ...
                <div class="tab-pane fade " id="settting_topbar" role="tabpanel">
                    <form id="formtopbar" method="POST" action="{{ route('admin.topbarinsert') }}"
                        onsubmit="return false">
                        @csrf
                ...
                <div class="tab-pane fade " id="settting_sendemail" role="tabpanel">
                    <form id="formsendmail" method="POST" action="{{ route('admin.email') }}" onsubmit="return false">
                        {{-- @csrf --}}
                ...
                <div class="tab-pane fade pickr " id="settting_color" role="tabpanel">
                    <form id="formcolor" method="POST" action="{{ route('admin.color_insert') }}"
                        onsubmit="return false">
                        {{-- @csrf --}}
