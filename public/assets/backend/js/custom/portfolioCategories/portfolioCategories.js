$(document).ready(function () {
    ...
    var load = $('.portfolioCategories').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: BASE_URL + ADMIN + '/portfolioCategories/list',
        type: "post",
        ajax: {
            url: BASE_URL + ADMIN + '/portfolioCategories/list',
            type: 'POST',
            data: {
                "_token": token,
            },
    ...
    $("#addCategories form").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: BASE_URL + ADMIN + '/portfolioCategories/insert',
                type: "post",
                data: data,
    ...
    $(document).on('click', "#categories_edit",function () {
        ...
        $.ajax({
            url: BASE_URL + ADMIN + '/portfolioCategories/edit',
            type: 'post',
            data: {
                "_token": token,
                "id": id,
    ...
    $(document).on('click', "#categories_delete",function () {
        ...
        Swal.fire({
            ...
            if (data.value) {
                $.ajax({
                    url: BASE_URL + ADMIN + '/portfolioCategories/delete',
                    type: "post",
                    data: {
                        "_token": token,
                        "id": id,
